...
firstLanguage (Javascript), secondLanguage(Javascript)  et thirdLanguage (HTML)
...
firstLanguage (Javascript), secondLanguage(Javascript) et thirdLanguage (Javascript)